...
<body>
    <svg id="yetiSVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <g id="fingersBackL" style="visibility: hidden;" fill="#88C9F2" stroke="#265D85" stroke-linecap="round"
            ...
            <path
                d="M128.6 177.3l-4.4-18.4c-.6-2.7 1-5.4 3.7-6 2.7-.6 5.4 1 6 3.7l5.6 23.3-4.9 1.2c-2.7.5-5.4-1.2-6-3.8z" />
        </g>
    ...
    <div class="content">
        ...
        <p>We know it’s scary, but the page you’re trying to reach can’t be found. Perhaps it was just a bad
            <span>link</span> dream?</p>
    </div>
